...
class AuthProvider with ChangeNotifier{
  ...
  Future<Map<String,dynamic>> loginUser (String email, String password,bool isLogin) async{

        final url = Uri.parse('https://onsitetracking.trottedmedia.com/api/api.php');
